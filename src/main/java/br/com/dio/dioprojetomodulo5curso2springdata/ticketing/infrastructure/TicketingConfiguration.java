package br.com.dio.dioprojetomodulo5curso2springdata.ticketing.infrastructure;
...
@EnableJpaRepositories(basePackages = "br.com.dio.dioprojetomodulo5curso2springdata.ticketing", entityManagerFactoryRef = "ticketingEntityManagerFactory", transactionManagerRef = "ticketingTransactionManager")
@EnableRedisRepositories(basePackages = "br.com.dio.dioprojetomodulo5curso2springdata.ticketing", redisTemplateRef = "ticketingRedisTemplate")
public class TicketingConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean ticketingEntityManagerFactory(@Qualifier("ticketing") DataSource dataSource,
        ...
        return builder
                ...
                .packages("br.com.dio.dioprojetomodulo5curso2springdata.ticketing")
