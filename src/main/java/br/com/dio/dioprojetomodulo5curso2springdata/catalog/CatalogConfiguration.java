package br.com.dio.dioprojetomodulo5curso2springdata.catalog;
...
@EnableJpaRepositories(basePackages = "br.com.dio.dioprojetomodulo5curso2springdata.catalog",
...
public class CatalogConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean catalogEntityManagerFactory(@Qualifier("catalog") DataSource dataSource,
        ...
        return builder
                ...
                .packages("br.com.dio.dioprojetomodulo5curso2springdata.catalog")
