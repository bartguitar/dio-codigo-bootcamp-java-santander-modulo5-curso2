...
import br.com.dio.dioprojetomodulo5curso2springdata.catalog.domain.*;
...
public class MongoEventMetadataRepository implements EventMetadataRepository {
    ...
    private static EventMetadata mapper(br.com.dio.dioprojetomodulo5curso2springdata.catalog.infrastructure.persistence.entity.EventMetadata eventMetadata) {
    ...
    private static Seat mapper(br.com.dio.dioprojetomodulo5curso2springdata.catalog.infrastructure.persistence.entity.EventMetadata.Seat seat) {
        return new Seat(new SeatId(seat.getCode()), new SectorId(seat.getSectorName()));
    }

    private static Sector mapper(br.com.dio.dioprojetomodulo5curso2springdata.catalog.infrastructure.persistence.entity.EventMetadata.Sector sector) {
